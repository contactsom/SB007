...
public class UpdateStatementExample {
	...
	public static void main(String[] args) {
		try {
			...
			int records = stmt.executeUpdate("UPDATE Employees SET firstName ='Saravana' where id=108");
			
			if(records>0) {
				System.out.println("Record Update Successfully in to table Employees");
			}else {
				System.out.println("Error occured while Updating the data  in to table Employees");
			}
